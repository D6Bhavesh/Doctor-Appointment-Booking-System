...
export const RelatedDoctors = ({speciality, docId}) => {
    ...
    <div className='flex flex-col items-center my-16 gap-4 text-gray-900 md:mx-10'>
        ...
        <div className='w-full grid autogrid gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
        ...
        <button onClick={()=>{navigate("/doctors")}}className='bg-blue-50 text-gray-600 py-3 px-12 rounded-full mt-10 cursor-pointer'>more</button>
    </div>
  )
}
